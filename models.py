...
class SiteSettings(db.Model):
    ...
    landing_video_after_title    = db.Column(db.String(500), default='')
    landing_video_after_hook     = db.Column(db.String(500), default='')
    landing_video_after_what_is  = db.Column(db.String(500), default='')
    landing_video_after_how_helps = db.Column(db.String(500), default='')
    landing_video_after_explore  = db.Column(db.String(500), default='')
    landing_video_after_includes = db.Column(db.String(500), default='')
    landing_video_after_for_you  = db.Column(db.String(500), default='')
    landing_video_after_closing  = db.Column(db.String(500), default='')
    landing_success_text         = db.Column(db.Text, default='')
    landing_success_button_text  = db.Column(db.String(200), default='')
    landing_success_footer       = db.Column(db.Text, default='')
    ...
    commercial_success_text      = db.Column(db.Text, default='')
    commercial_success_button_text = db.Column(db.String(200), default='')
    commercial_success_footer    = db.Column(db.Text, default='')
    commercial_existing_text     = db.Column(db.Text, default='')
