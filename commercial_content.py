...
<p><a href="{{whatsapp_url}}" style="display:inline-block;background:#25D366;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:600">Entrar al grupo</a></p>
<p style="color:#71717a;font-size:12px">Si el botón no funciona, copia este enlace: {{whatsapp_url}}</p>''',
}
