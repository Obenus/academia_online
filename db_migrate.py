...
def run_migrations(conn):
    stmts = [
        ...
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS landing_video_url VARCHAR(500) DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS landing_video_after_title VARCHAR(500) DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS landing_video_after_hook VARCHAR(500) DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS landing_video_after_what_is VARCHAR(500) DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS landing_video_after_how_helps VARCHAR(500) DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS landing_video_after_explore VARCHAR(500) DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS landing_video_after_includes VARCHAR(500) DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS landing_video_after_for_you VARCHAR(500) DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS landing_video_after_closing VARCHAR(500) DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS legal_community_md TEXT DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS legal_privacy_md TEXT DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS legal_cookies_md TEXT DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS legal_notice_md TEXT DEFAULT ''",
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS commercial_landing_enabled BOOLEAN DEFAULT FALSE",
        ...
        "ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS commercial_lead_notify_email VARCHAR(200) DEFAULT ''",
